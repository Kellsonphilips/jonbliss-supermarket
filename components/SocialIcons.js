// Social Authentication Icons Component
// Contains SVG icons for all supported social login providers
...
export const MicrosoftIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M0 0h11v11H0V0zm13 0h11v11H13V0zM0 13h11v11H0V13zm13 13h11V13H13v11z"/>
  </svg>
);
...
export const getSocialIcon = (provider) => {
