          ...
          <div className="max-w-md mx-auto text-center">
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 px-4 py-2 border border-gray-600 rounded-l-lg bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
              />
              <button className="px-6 py-2 bg-primary text-white rounded-r-lg hover:bg-red-orange transition-colors duration-200">
                Subscribe
              </button>
            </div>
          </div>
