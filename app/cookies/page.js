  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Learn about how Jonbliss Supermarket uses cookies and similar technologies to enhance your browsing experience." />
              ...
              {activeTab === 'overview' && (
                <div>
                  ...
                  <div className="space-y-6 text-gray-700 leading-relaxed">
                    ...
                    <p>
                      Jonbliss Supermarket uses cookies and similar technologies to:
                    </p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-3">Types of Information Collected</h3>
                    <p>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                      ...
                      <p className="text-blue-800">
                        Cookies do not contain personally identifiable information unless you have provided it to us. We use the information collected through cookies to improve your experience and provide better services.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-8">
                    ...
                    <p className="text-gray-700 mb-6">
                      We also use third-party services that may set their own cookies. These services help us provide better functionality and analyze our website performance.
                    </p>
                    ...
                    <div className="space-y-4">
                      {thirdPartyCookies.map((service, index) => (
                        <div key={index} className="border border-gray-200 rounded-lg p-4">
                          ...
                          <p className="text-gray-700 mb-2"><strong>Purpose:</strong> {service.purpose}</p>
                          <p className="text-gray-700 text-sm"><strong>Data Collected:</strong> {service.dataCollected}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 mb-4">
                        For third-party cookies, you can opt out through the following methods:
                      </p>
                      <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                        ...
                        <li><strong>Advertising Networks:</strong> Visit the Digital Advertising Alliance website</li>
                      </ul>
                    </div>
